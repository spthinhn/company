                        ...
                        <li class="nav-item dropdown notification-list">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-arrow-success dropdown-lg" aria-labelledby="Preview">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    ...
                                    <?php echo $this->Html->image('users/avatar-2.jpg', ['class' => 'img-circle img-fluid']); ?>
                                    </div>
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="notify-icon bg-faded">
                                        <?php echo $this->Html->image('users/avatar-3.jpg', ['class' => 'img-circle img-fluid']); ?>
                                    </div>
                                    <p class="notify-details">
                                        <b>Carlos Crouch</b>
                                        <span>New tasks needs to be done</span>
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="notify-icon bg-faded">
                                    <?php echo $this->Html->image('users/avatar-4.jpg', ['class' => 'img-circle img-fluid']); ?>
                                    </div>
                                    <p class="notify-details">
                                        <b>Robert Taylor</b>
                                        <span>New tasks needs to be done</span>
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <a href="javascript:void(0);" class="waves-effect"><i class="zmdi zmdi-format-underlined"></i> <span> Staff Interface </span> <span class="menu-arrow"></span></a>
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="zmdi zmdi-album"></i> <span> Manager Users </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li>
                                        <?php 
                                            echo $this->Html->link(
