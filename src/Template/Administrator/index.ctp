                                        ...
                                        <div class="card-box">
                                            ...
                                            <div class="inbox-widget nicescroll" style="height: 320px;">
                                                ...
                                                <a href="#">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img">
                                                        <?php echo $this->Html->image('users/avatar-5.jpg'); ?> 
                                                        </div>
                                                ...
                                                <a href="#">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img">
                                                        <?php echo $this->Html->image('users/avatar-6.jpg'); ?> 
                                                        </div>
                                                ...
                                                <a href="#">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img">
                                                        <?php echo $this->Html->image('users/avatar-8.jpg'); ?> 
                                                        </div>
                                                ...
                                                <a href="#">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img">
                                                        <?php echo $this->Html->image('users/avatar-9.jpg'); ?> 
                                                        </div>
